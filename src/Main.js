...
const Main = () => {
  ...
  const objectBlockRef = useRef(null)
  ...
  const reviews = [
    <Review
      ...
      text="Текст отзыва, оставленного клиентом в Телеграм канале, который можно открыть нажав на кнопку в правом верхнем углу этого блока."
    />,
    <Review key={2} name="Maxim L." link="https://t.me" text="Отзыв оставленный Максимом." />,
    <Review key={3} name="Petr O." link="https://t.me" text="Подписывайся на телеграм канал." />,
  ]
  ...
  useEffect(() => {
    const box = containerRef.current
    const firstReview = box.querySelector(".review-card")
    reviewWidthRef.current = firstReview ? firstReview.clientWidth : 0
    const width = reviewWidthRef.current * visibleReviews
  ...
  // Improved navigation function that scrolls to a specific element
    ...
    <div>
      <header style={{ zIndex: "1" }}>
        {isPortrait ? (
          <div className="navigation">
            <div className="menu">
              <a onClick={() => scrollToRef(welcomeBlockRef)}>О Фирме</a>
              <a onClick={() => scrollToRef(serviceBlockRef)}>Услуги</a>
              <a onClick={() => scrollToRef(objectBlockRef)}>Объекты</a>
              <a onClick={() => scrollToRef(reviewBlockRef)}>Отзывы</a>
              <a onClick={() => scrollToRef(contactsBlockRef)}>Контакты</a>
            </div>
            <div className="header-buttons">
              <button onClick={handleOpenModal} className="btn">
                Связаться
          ...
          <div className="navigation">
            ...
            <div className="header-buttons-mobile">
              ...
              <a
                href="https://instagram.com/"
                target="_blank"
                className={theme === "light" ? "icon icon-mobile instagram light" : "icon icon-mobile instagram dark"}
                rel="noreferrer"
              ></a>
              <a onClick={handleOpenModalMenu} className={theme === "light" ? "icon-menu light" : "icon-menu dark"}></a>
            </div>
          </div>
        )}
      </header>
      ...
      <ModalWindow show={showModal} onClose={handleCloseModal}>
        <h2 style={{ color: "#4824ff", fontSize: isPortrait ? "40px" : "15vw", marginTop: isPortrait ? "" : "0" }}>
          Контакты
        </h2>
        {isPortrait ? (
          <p style={{ fontSize: "22px" }}>
      ...
      {isPortrait ? (
        <div className="welcome-block" ref={welcomeBlockRef}>
          <div className="first-block">
            <h1 style={{ color: "#4824ff" }}>
          ...
          <div className="main-image-box">
            <img className="first-image-layer" src="./images/logo-2-layer.png" draggable="false" />
            <img className="second-image-layer" src="./images/logo-1-layer.png" draggable="false" />
          </div>
        </div>
      ) : (
        <div className="welcome-block mobile" ref={welcomeBlockRef}>
          <div className="main-image-box mobile">
            <img className="first-image-layer mobile" src="./images/logo-2-layer.png" draggable="false" />
            <img className="second-image-layer mobile" src="./images/logo-1-layer.png" draggable="false" />
          </div>
          <div className="first-block mobile">
            <h1 style={{ color: "#4824ff" }}>
              ОАО РПИИ <span className="title">Якутпроект</span> Республиканский проектно-изыскательский институт
      ...
      <div className={isPortrait ? "service-block" : "service-block mobile"} ref={serviceBlockRef} draggable="false">
        <h1 style={{ fontSize: isPortrait ? "52px" : "10vw" }}>УСЛУГИ</h1>
        <p style={{ fontSize: isPortrait ? "27px" : "6vw" }}>
      ...
      <div className="object-block" ref={objectBlockRef}>
        <div className={isPortrait ? "first-block" : "first-block mobile"}>
          <h1 className={isPortrait ? "main-title" : "main-title mobile"}>Объекты</h1>
          <div style={{ position: "absolute", marginLeft: isPortrait ? "-560px" : "-50vw" }}>
            <p className={isPortrait ? "gradient-part-one" : "gradient-part-one mobile"}></p>
        ...
        <div className={isPortrait ? "" : "filter-scrollbar"}>
          ...
          >
            ...
            <p
              className={`tag ${selectedCategory === "LivingBuilding" ? "selected" : ""} ${isPortrait ? "" : "mobile"}`}
              onClick={() => setSelectedCategory("LivingBuilding")}
            >
              Жилые дома
            </p>
            ...
            <p
              className={`tag ${selectedCategory === "SportBuildings" ? "selected" : ""} ${isPortrait ? "" : "mobile"}`}
              onClick={() => setSelectedCategory("SportBuildings")}
            >
              Спортивные сооружения
            </p>
            ...
            <p
              className={`tag ${selectedCategory === "GeneralPlans" ? "selected" : ""} ${isPortrait ? "" : "mobile"}`}
              onClick={() => setSelectedCategory("GeneralPlans")}
            >
              Генеральные планы
            </p>
      ...
      <div className={isPortrait ? "review-block" : "review-block mobile"} ref={reviewBlockRef}>
        <h1 style={{ fontSize: isPortrait ? "50px" : "10vw" }}>ОТЗЫВЫ</h1>
        <p className={isPortrait ? "description" : "description mobile"}>
          Отзывы клиентов, написанные со своих <span className="selecting"> личных аккаунтов </span>Телеграм. Всё
          прозрачно! <br /> Любой отзыв можно <span className="selecting"> открыть </span>в Телеграм и{" "}
          <span className="selecting"> спросить </span>об впечатлениях работы с нами <br /> у создателя отзыва лично.
        </p>
      ...
      <div className={isPortrait ? "contacts-block" : "contacts-block mobile"} ref={contactsBlockRef}>
        <h1 style={{ fontSize: isPortrait ? "52px" : "10vw", paddingBottom: isPortrait ? "20px" : "0" }}>КОНТАКТЫ</h1>
      ...
      <button
        className={scroll < 1960 ? "" : isPortrait ? "btn-up" : "btn-up mobile"}
        onClick={() => scrollToRef(welcomeBlockRef)}
      ></button>
    </div>
  )
}
